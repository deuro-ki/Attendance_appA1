...
#  department                 :string
#  basic_time                 :datetime         default(Mon, 07 Feb 2022 08:00:00 JST +09:00), not null
#  work_time                  :datetime         default(Mon, 07 Feb 2022 07:30:00 JST +09:00), not null
#  superior                   :boolean          default(FALSE), not null
#  designated_work_start_time :datetime         default(Mon, 07 Feb 2022 09:00:00 JST +09:00), not null
#  designated_work_end_time   :datetime         default(Mon, 07 Feb 2022 18:00:00 JST +09:00), not null
...
class User < ApplicationRecord
  ...
  validates :employee_number, length: {maximum: 4}, uniqueness: true, allow_blank: true
